...
const Hero = () => {
  return (
    <section className="w-full flex flex-col md:flex-row justify-center items-center md:pt-[15%] xl:pt-[10%]">
      {/* Left section */}
      <div className="w-full h-[50%] max-h-[50%] flex justify-center items-center flex-1 text-center flex-col p-5 pb-6 mt-5 md:mt-0 md:mb-0 md:pt-[10%] md:pb-[10%]">
        ...
        <div className="m-2">
          ...
          <Link href="/pages/products">
            <Button className="upercase bg-blue-600 text-white hover:bg-blue-500">
              Shop Now
            </Button>
          </Link>
        </div>
